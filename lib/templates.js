...
export const templates = {
  ...
  'dark-dev': {
    ...
    accentVar: '#00d9ff',
    // Navbar
    navbarBrand: 'text-[var(--portfolio-accent)] font-mono font-bold tracking-widest',
    // Skills
    skillCardClass: 'portfolio-card p-4 border border-[var(--portfolio-accent)]/20 font-mono',
    // Stat cards
    statCardClass: 'portfolio-card p-6 border border-[var(--portfolio-accent)]/20',
  },
