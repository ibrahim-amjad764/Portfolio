...
function InputField({ id, label, error, children }) {
  return (
    <div className="flex flex-col gap-1.5">
      <label
        htmlFor={id}
        className="text-sm font-semibold text-[var(--portfolio-text)]"
      >
        {label}
      </label>
      {children}
      ...
      <div className="container-max">
        ...
        <FadeInSection className="mb-12 sm:mb-16">
          ...
          <p className="mt-3 text-[var(--portfolio-muted)] max-w-xl">
            {isDarkDev ? "" : ""}Have a project in mind or want to collaborate?
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <FadeInSection direction="left">
            ...
            >
              ...
              <PulseBeamButton className="w-full">
                <MotionButton
          ...
          <FadeInSection direction="right" className="space-y-8">
            <div className="portfolio-card p-6 space-y-5">
              <h3
                className={`font-bold text-lg text-[var(--portfolio-text)] ${isDarkDev ? "font-mono" : ""}`}
              >
                Contact Details
              </h3>
              ...
              >
                ...
                <div>
                  <p className="text-xs text-[var(--portfolio-muted)] font-medium mb-0.5">
                    Email
                  </p>
                  <p
                    className="text-[var(--portfolio-text)] font-semibold group-hover:text-[var(--portfolio-accent)]
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--portfolio-text)] font-semibold">
                    {data.location}
                  </p>
                </div>
              </div>
                ...
                {socials.map(({ href, label, icon: Icon }) =>
                  href.startsWith("mailto:") ? (
                    <motion.a
                      ...
                      whileHover={{ x: 4 }}
                      className="flex cursor-pointer items-center gap-3 text-[var(--portfolio-muted)]
                    ...
                    <HoverPeek key={label} url={href} className="block">
                      <motion.a
                        href={href}
                        target="_blank"
            ...
            >
              ...
              />
              <p
                className={`text-sm font-medium text-emerald-400 ${isDarkDev ? "font-mono" : ""}`}
              >
