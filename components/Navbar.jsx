...
export default function Navbar({ name = "PortifyAI" }) {
  ...
  // IMPORTANT:
  // Scroll behavior remains exactly the same as your original code.
  useEffect(() => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* ── Desktop Links ──────────────────────────────────────────── */}
          {/*
              Same activeSection + IntersectionObserver behavior.

              Only the visual design has been changed:
              - Outer rounded border
              - Active item gets a pill background
              - Smooth active-pill movement
            */}
          <div
            className="
                hidden
